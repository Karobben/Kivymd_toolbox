...
class FunctionWidget():
    ...
    def main(self):
        ...
        self.Function_page = Builder.load_string(self.OPEN("Layout/Font.kv"))
        ...
        self.Font_list = {"繁体": "FangZhengHeiTiFanTi-1.ttf", "拼音":"FangZhengKaiTiPinYinZiKu-1.ttf", "新篆":"HuaKangXinZhuanTi-1.ttf", "角篆":"JingDianFanJiaoZhuan-1.ttf","小篆":"FangzhenXiaozhuan.ttf"}
        for i in range(len(self.Font_list)):
            Name = "".join([i for i in list(self.Font_list.keys())[i]])
            Name = "".join(["[font=./font/", self.Font_list[Name] , "]", Name, "[/font]"])
