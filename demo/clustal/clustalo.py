...
parser.add_option('--hmmiterations', type=int, help=('Having set the number of combined iterations, this parameter can be'
                  ...
                  'iterations.'))
parser.add_option('--outfmt', type=str, default = "fa", help=('Format for generated multiple sequence alignment.'))
...
parser.add_option('--sequence', default="/media/ken/Data/Github/Kivymd_toolbox/Ilarvirus-RNA3.txt", type=str, help=('Three or more sequences to be aligned can be entered directly into'
...
parser.add_option('--email', help='E-mail address.',default="a591465908@outlook.com")
parser.add_option('--title', help='Job title.')
parser.add_option('--outfile', default = "clusttmp/result", help='File name for results.')
